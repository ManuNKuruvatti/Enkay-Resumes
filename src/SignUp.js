...
const SignUp = () => {
  ...
  const handleClick = () => {
    ...
    if (!name || !email || !password || !repeatPassword || !termsCheckbox) {
      alert('Fill in all the details correctly.');
    } else {
      // If all details are filled correctly, you can proceed with registration.
      navigate('/');
    }
  };
